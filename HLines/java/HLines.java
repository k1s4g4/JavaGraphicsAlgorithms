...
{
    private JMenuItem open,exportHPGL,exit,eyeUp,eyeDown,eyeLeft,eyeRight,incrDist,decrDist;
    private String sDir;
    private CvHLines cv;
    private Obj3D obj;
    public HLines(String argFileName)
    {
        ...
        exportHPGL=new JMenuItem("Export HP-GL");
        ...
        cv.setBackground(new Color(0,0,0));
    ...
    class MenuCommands implements ActionListener{
        ...
        public void actionPerformed(ActionEvent evt){
            if(evt.getSource() instanceof JMenuItem){
                ...
                if(mi==open){
                    FileDialog fDia=new FileDialog(HLines.this,"Open",FileDialog.LOAD);
